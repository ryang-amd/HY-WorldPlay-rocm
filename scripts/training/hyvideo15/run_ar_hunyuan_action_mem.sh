...
OUTPUT_DIR=/data/ruijyang/training_output/run_dc_v7_warmup_primus_docker_0406
...
# Cosine schedule with min_lr_ratio=0.1 decays to 5e-6 over 1500 steps.
optimizer_args=(
  --learning_rate 5e-5
